...
val validate_with_action_f
      ...
      (#has_action:bool)
      (#allow_reading:bool)
      (v:validate_with_action_t p liveness_inv disj l has_action allow_reading ret_t):
      //ghost function that specifies which (subset of) parsed values are returned by the validator
      t -> GTot ret_t
...
val validate_eta
      ...
      (#ret_t:Type0)
      (v: validate_with_action_t p inv disj l has_action allow_reading ret_t)
: Tot (validate_with_action_t p inv disj l has_action allow_reading ret_t)
...
val validate_without_reading
      ...
      (#ret_t: Type0)
      (v: validate_with_action_t p inv disj l has_action allow_reading ret_t)
: Tot (validate_with_action_t p inv disj l has_action false ret_t)
...
val validate_with_success_action
      ...
      (#has_action #allow_reading:bool)
      (#ret_t: Type0)
      (v1:validate_with_action_t p1 inv1 disj1 l1 has_action allow_reading ret_t)
      (#[@@@erasable] inv2:slice_inv)
      (#[@@@erasable] disj2:disjointness_pre)
      (#[@@@erasable] l2:eloc)
      (#b #rt:bool)
      (a:action inv2 disj2 l2 b rt bool)
  : validate_with_action_t p1 (conj_inv inv1 inv2) (conj_disjointness disj1 disj2) (l1 `eloc_union` l2) true false ret_t
...
val validate_with_error_handler
      ...
      (#has_action #ar:_)
      (#ret_t: Type0)
      (v1:validate_with_action_t p1 inv1 disj l1 has_action ar ret_t)
  : validate_with_action_t p1 inv1 disj l1 has_action ar ret_t

val validate_with_action_f_validate_with_error_handler
      (typename: string)
      (fieldname: string)
      (#nz: _)
      (#wk: _)
      ...
      (v1:validate_with_action_t p1 inv1 disj l1 has_action ar ret_t)
: Lemma
  (ensures validate_with_action_f (validate_with_error_handler typename fieldname v1) == validate_with_action_f v1)
  [SMTPat (validate_with_error_handler typename fieldname v1)]

inline_for_extraction noextract
val validate_ret
  : validate_with_action_t (parse_ret ()) true_inv disjointness_trivial eloc_none false true unit
...
val validate_pair
       ...
       (#ret_t1: Type0)
       (v1:validate_with_action_t p1 inv1 disj1 l1 has_action1 allow_reading1 ret_t1)
       (#nz2:_)
       (#wk2: _)
       ...
       (#ret_t2: Type0)
       (v2:validate_with_action_t p2 inv2 disj2 l2 has_action2 allow_reading2 ret_t2)
...
let parse_dep_pair_gen_payload 
      (#t1:Type)
      (#ret_t1: Type0)
      (f:t1 -> GTot ret_t1)
      (#nz2:_)
...
val validate_dep_pair_gen 
      ...
      (#has_action1:_)
      (#ret_t1: Type0)
      (v1:validate_with_action_t p1 inv1 disj1 l1 has_action1 false ret_t1)
      (#nz2:_)
      (#wk2: _)
      (#k2:parser_kind nz2 wk2)
      (#[@@@erasable] t2:ret_t1 -> Type)
      ...
      (v2:(x: ret_t1 -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
      (p1 `parse_dep_pair` parse_dep_pair_gen_payload (validate_with_action_f v1) p2)
      (conj_inv inv1 inv2)
      (conj_disjointness disj1 disj2)
      (l1 `eloc_union` l2)
      (has_action1 || has_action2)
...
let validate_dep_pair_gen_error_handeler
      (typename:string)
      (name1: string)
      (#nz1:_)
      (#k1:parser_kind nz1 WeakKindStrongPrefix)
  ...
  : validate_with_action_t
      ...
      false
      ret_t2
      = coerce_eq (validate_with_action_f_validate_with_error_handler typename name1 v1)
      (validate_dep_pair_gen name1 (validate_with_error_handler typename name1 v1) v2)
...
val validate_dep_pair
      ...
      (#[@@@erasable] l1:eloc)
      (#has_action1:_)
      (v1:validate_with_action_t p1 inv1 disj1 l1 has_action1 true unit)
      (r1: leaf_reader p1)
      (#nz2:_)
      (#wk2: _)
      (#k2:parser_kind nz2 wk2)
      ...
      (#has_action2 #allow_reading2:bool)
      (#ret_t2: Type0) //the return type of the second parser must not depend on the values read by the first parser (for extraction)
      (v2:(x:t1 -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
...
val validate_return
    (#ret_t: Type0)
    (x: ret_t)
  : validate_with_action_t (parse_ret ()) true_inv disjointness_trivial eloc_none false true ret_t
...
val validate_dep_pair_with_refinement_and_action_gen
      ...
      (#has_action1:bool)
      (#ret_t1: Type0)
      (v1:validate_with_action_t p1 inv1 disj1 l1 has_action1 true ret_t1)
      (f: ret_t1 -> bool)
      (#[@@@erasable] inv1':slice_inv)
      (#[@@@erasable] disj1':disjointness_pre)
      (#[@@@erasable] l1':eloc)
      ...
      (#wk2: _)
      (#k2:parser_kind nz2 wk2)
      (#[@@@erasable] t2:refine t1 (fun x1 -> f ((validate_with_action_f v1) x1)) -> Type)
      (#[@@@erasable] p2:(x:refine t1 (fun x1 -> f ((validate_with_action_f v1) x1)) -> parser k2 (t2 x)))
      (#[@@@erasable] inv2:slice_inv)
      (#[@@@erasable] disj2:disjointness_pre)
      (#[@@@erasable] l2:eloc)
      (#has_action2 #allow_reading2:bool)
      (#ret_t2: Type0) //the return type of the second parser must not depend on the values read by the first parser (for extraction)
      (v2:(x:refine t1 (fun x1 -> f ((validate_with_action_f v1) x1)) -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
      ((p1 `parse_filter` (fun (x1:t1) -> f ((validate_with_action_f v1) x1))) `parse_dep_pair` p2)
...
val validate_dep_pair_with_refinement_and_action
      ...
      (#has_action2 #allow_reading2:bool)
      (#ret_t2: Type0)
      (v2:(x:refine _ f -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
...
val validate_dep_pair_with_action_gen
      ...
      (v2:(x:ret_t1 -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
      (p1 `(parse_dep_pair #nz1)` (fun (x1: t1) -> p2 ((validate_with_action_f v1) x1)))
      (conj_inv inv1 (conj_inv inv1' inv2))
      (conj_disjointness disj1 (conj_disjointness disj1' disj2))
      (l1 `eloc_union` (l1' `eloc_union` l2))
      true
...
val validate_dep_pair_with_refinement_gen
      ...
      (v2:(x:refine t1 (fun x1 -> f ((validate_with_action_f v1) x1)) -> validate_with_action_t (p2 x) inv2 disj2 l2 has_action2 allow_reading2 ret_t2))
  : validate_with_action_t
      ((p1 `parse_filter` (fun x1 -> f ((validate_with_action_f v1) x1))) `parse_dep_pair` p2)
      (conj_inv inv1 inv2)
      (conj_disjointness disj1 disj2)
      (l1 `eloc_union` l2)
      (has_action1 || has_action2)
...
val validate_filter_gen
       ...
       (#has_action:_)
       (#ret_t:Type0)
       (v:validate_with_action_t p inv disj l has_action true ret_t)
       (f:ret_t -> bool)
       (cr:string)
       (cf:string)
  : validate_with_action_t (p `parse_filter` (fun x -> f ((validate_with_action_f v) x))) inv disj l has_action false ret_t
...
val validate_filter
       ...
       (#[@@@erasable] l:eloc)
       (#has_action:_)
       (v:validate_with_action_t p inv disj l has_action true unit)
       (r:leaf_reader p)
       (f:t -> bool)
       (cr:string)
       (cf:string)
  : validate_with_action_t (p `parse_filter` f) inv disj l has_action false unit
...
val validate_filter_with_action_gen
  ...
  : validate_with_action_t #nz
      (p `parse_filter` (fun x -> f ((validate_with_action_f v) x)))
      (conj_inv inv inva)
...
val validate_weaken_left
       ...
       (#wk': _)
       (k':parser_kind nz' wk')
  : validate_with_action_t (parse_weaken_left p k') inv disj l has_action allow_reading ret_t
...
val validate_weaken_right
       ...
       (#wk': _)
       (k':parser_kind nz' wk')
  : validate_with_action_t (parse_weaken_right p k') inv disj l has_action allow_reading ret_t

inline_for_extraction noextract
val validate_impos
       (_:unit)
  : validate_with_action_t (parse_impos ()) true_inv disjointness_trivial eloc_none false true unit
...
val validate_ite
       ...
       (v1:(squash e -> validate_with_action_t (p1()) inv1 disj1 l1 ha1 ar1 ret_t))
       ([@@@erasable] p2:squash (not e) -> parser k (b()))
       (v2:(squash (not e) -> validate_with_action_t (p2()) inv2 disj2 l2 ha2 ar2 ret_t))
  : validate_with_action_t
      (parse_ite e p1 p2)
      (conj_inv inv1 inv2)
      (conj_disjointness disj1 disj2)
...
val validate_nlist
       ...
       (#ret_t:Type0)
       (v: validate_with_action_t p inv disj l ha allow_reading ret_t)
: validate_with_action_t (parse_nlist n n_is_const p) inv disj l ha false unit // nlist validator does not return (would incur heap-allocation)
...
val validate_nlist_constant_size_without_actions
       ...
       (#allow_reading:bool)
       (#ret_t:Type0)
       (v: validate_with_action_t p inv disj l false allow_reading ret_t)
: Tot (validate_with_action_t (parse_nlist n n_is_const p) inv disj l false false unit) // nlist validator does not return (would incur heap-allocation)
...
val validate_t_at_most
       ...
       (#ha #ar:_)
       (#ret_t:Type0)
       (v:validate_with_action_t p inv disj l ha ar ret_t)
  : Tot (validate_with_action_t (parse_t_at_most n p) inv disj l ha false unit) // t_at_most validator does not return
...
val validate_t_exact
       ...
       (#ret_t:Type0)
       (v:validate_with_action_t p inv disj l ha ar ret_t)
  : Tot (validate_with_action_t (parse_t_exact n p) inv disj l ha false unit) // t_exact validator does not return
...
val validate_with_comment
       ...
       (#ret_t:Type0)
       (v:validate_with_action_t p inv disj l ha allow_reading ret_t)
  : validate_with_action_t p inv disj l ha allow_reading ret_t
...
val validate_weaken_inv_loc
       ...
       (#ret_t:Type0)
       (v:validate_with_action_t p inv disj l ha allow_reading ret_t)
  : Tot (validate_with_action_t p inv' disj' l' ha allow_reading ret_t)
...
inline_for_extraction
let validator #nz #wk (#k:parser_kind nz wk) (#t:Type) (p:parser k t) (ret_t:Type0)
  = validate_with_action_t p true_inv disjointness_trivial eloc_none false true ret_t

inline_for_extraction
let validator_maybe_action #nz #wk (#k:parser_kind nz wk) (#t:Type) (p:parser k t) (has_action:bool) 
  (ret_t:Type0)
  = validate_with_action_t p true_inv disjointness_trivial eloc_none has_action true ret_t

inline_for_extraction noextract
val validate____UINT8
  : validator parse____UINT8 unit
...
val validate____UINT8BE
  : validator parse____UINT8BE unit
...
val validate____UINT16BE
  : validator parse____UINT16BE unit
...
val validate____UINT32BE
  : validator parse____UINT32BE unit
...
val validate____UINT64BE
  : validator parse____UINT64BE unit
...
val validate____UINT16
  : validator parse____UINT16 unit
...
val validate____UINT32
  : validator parse____UINT32 unit
...
val validate____UINT64
  : validator parse____UINT64 unit
...
val validate_unit_refinement (f:unit -> bool) (cf:string)
  : validator (parse_unit `parse_filter` f) unit
...
val validate_string
       ...
       (#[@@@erasable] p: parser k t)
       (#ha:_)
       (v: validator_maybe_action p ha unit)
       (r: leaf_reader p)
       (terminator: t)
  : Tot (validate_with_action_t (parse_string p terminator) true_inv disjointness_trivial eloc_none ha false unit)
...
val validate_all_zeros
  : validate_with_action_t parse_all_zeros true_inv disjointness_trivial eloc_none false false unit
